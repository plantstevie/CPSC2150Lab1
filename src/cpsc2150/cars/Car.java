...
public class Car {
    ...
    /**
     * This method overrides the default implementation of {@code toString} to
     provide
     * a string representation of the object.
     *
     * @return a string representation of the car
     *
     * @post toString = "A [color], [year], [make] [model] with [miles] miles on
    it" AND
     *       color = #color AND year = #year AND make = #make AND model = #model
    AND miles = #miles
     */
    @Override
